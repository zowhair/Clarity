...
!(function (e, t) {
  ...
  function r(e, t) {
    var i;
    return (
      (e ? n.call(e.querySelectorAll("source, img")) : [t]).forEach(function (
        e
      ) {
        var t, a, n, r;
        i ||
          !(t = e.getAttribute("data-lowsrc")) ||
          ((n = (a = e).getAttribute("data-media") || a.getAttribute("media")),
          ((r = a.getAttribute("type")) && !o.test(r)) ||
            (n && !l.matchMedia(A.cfg.customMedia[n] || n).matches)) ||
          (i = t);
      }),
      i
    );
  ...
  function i(e, t, a, n) {
    ...
    a &&
      ((s = function (e) {
        (o = !0),
          ...
          A.rAF(function () {
            A.rC(t, A.cfg.blurUpLoadingClass),
              l && A.aC(l, A.cfg.blurUpLoadedClass);
          }),
          l &&
    ...
    var g = function (e) {
      f == e.target &&
        (A.aC(l || t, A.cfg.blurUpInviewClass),
        i(),
        f.removeEventListener("lazybeforeunveil", g));
    };
    f.getAttribute("data-expand") || f.setAttribute("data-expand", -1),
      f.addEventListener("lazybeforeunveil", g),
      A.aC(f, A.cfg.lazyClass);
  }
  var n = [].slice,
  ...
  l.addEventListener("lazybeforeunveil", function (e) {
    ...
    n.instance == A &&
      n.blurUp &&
      ("PICTURE" != (a = (t = e.target).parentNode).nodeName && (a = null),
      i(
        a,
        t,
        r(a, t) ||
    ...
    l.addEventListener("lazyunveilread", function (e) {
      ...
      n.instance == A &&
        ((t = e.target),
        ((a = (
          getComputedStyle(t, null) || { fontFamily: "" }
        ).fontFamily.match(s)) ||
          t.getAttribute("data-lowsrc")) &&
          (n.blurUp = (a && a[1]) || A.cfg.blurupMode || "always"));
    });
});
